            ...
            {isOwner && !isEditing && !isRetweet && (
              <div className="flex items-center gap-0.5 shrink-0">
                ...
                <DeleteConfirmDialog
                  ...
                  description="Il n'est pas possible d'annuler cette opération. Ce post sera supprimé de votre profil, du fil des comptes qui vous suivent et des résultats de recherche."
