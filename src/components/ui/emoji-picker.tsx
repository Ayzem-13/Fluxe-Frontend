...
interface EmojiItem {
  ...
  skin_variations?: Record<string, { unified: string; has_img_apple: boolean; has_img_google: boolean; has_img_twitter: boolean }>;
  obsoletes?: string;
  obsoleted_by?: string;
              ...
              return (
                <div key={category} className="mb-4 sm:mb-6">
                  ...
                  <div className="grid grid-cols-8 sm:grid-cols-9 gap-0.5 sm:gap-1">
                    {emojiList.map((emoji) => {
                      const skinVariant =
                        selectedSkinTone && emoji.skin_variations?.[selectedSkinTone];
                      const displayUnified = skinVariant
                        ? skinVariant.unified
                        : emoji.unified;
                      return (
                        <Button
